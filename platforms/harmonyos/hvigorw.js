...
e = g, Object.defineProperty(e, "__esModule", {
    value: !0
...
const N = S, {MAX_LENGTH: T, MAX_SAFE_INTEGER: x} = A, {safeRe: R, t: L} = C, k = P, {compareIdentifiers: B} = I;
...
let $ = class {
    constructor(e, t) {
        ...
        if (this.raw = e, this.major = +r[1], this.minor = +r[2], this.patch = +r[3], this.major > x || this.major < 0) {
...
const je = Oe, Me = Se, Ie = Ee, Ne = we, Te = De, xe = Pe;
...
function Qe() {
    ...
    class e {
        ...
        parseRange(e) {
            ...
            i("caret trim", e);
            let y = e.split(" ").map((e => m(e, this.options))).join(" ").split(/\s+/).map((e => j(e, this.options)));
            u && (y = y.filter((e => (i("loose invalid filter", e, this.options), !!e.match(a[s.COMPARATORLOOSE]))))), 
            i("range list", y);
            const g = new Map, E = y.map((e => new o(e, this.options)));
            for (const e of E) {
                if (v(e)) {
                    return [ e ];
                }
    ...
    const t = function() {
        ...
        return r;
    }, m = (e, t) => (i("comp", e, t), e = D(e, t), i("caret", e), e = E(e, t), i("tildes", e), 
    e = O(e, t), i("xrange", e), e = F(e, t), i("stars", e), e), g = e => !e || "x" === e.toLowerCase() || "*" === e, E = (e, t) => e.trim().split(/\s+/).map((e => b(e, t))).join(" "), b = (e, t) => {
        const r = t.loose ? a[s.TILDELOOSE] : a[s.TILDE];
        return e.replace(r, ((t, r, n, o, u) => {
            let a;
            return i("tilde", e, t, r, n, o, u), g(r) ? a = "" : g(n) ? a = `>=${r}.0.0 <${+r + 1}.0.0-0` : g(o) ? a = `>=${r}.${n}.0 <${r}.${+n + 1}.0-0` : u ? (i("replaceTilde pr", u), 
        ...
        return e.replace(r, ((t, r, o, u, a) => {
            let s;
            return i("caret", e, t, r, o, u, a), g(r) ? s = "" : g(o) ? s = `>=${r}.0.0${n} <${+r + 1}.0.0-0` : g(u) ? s = "0" === r ? `>=${r}.${o}.0${n} <${r}.${+o + 1}.0-0` : `>=${r}.${o}.0${n} <${+r + 1}.0.0-0` : a ? (i("replaceCaret pr", a), 
        ...
        return e.replace(r, ((r, n, o, u, a, s) => {
            ...
            const c = g(o), l = c || g(u), f = l || g(a), d = f;
    ...
    e.trim().replace(a[t.includePrerelease ? s.GTE0PRE : s.GTE0], "")), M = e => (t, r, n, o, i, u, a, s, c, l, f, d, p) => `${r = g(n) ? "" : g(o) ? `>=${n}.0.0${e ? "-0" : ""}` : g(i) ? `>=${n}.${o}.0${e ? "-0" : ""}` : u ? `>=${r}` : `>=${r}${e ? "-0" : ""}`} ${s = g(c) ? "" : g(l) ? `<${+c + 1}.0.0-0` : g(f) ? `<${c}.${+l + 1}.0-0` : d ? `<=${c}.${l}.${f}-${d}` : e ? `<${c}.${l}.${+f + 1}-0` : `<=${s}`}`.trim(), I = (e, t, r) => {
...
const mt = H, gt = et(), {ANY: Et} = gt, bt = Qe(), Dt = rt, _t = Ee, Ot = De, At = Pe, St = we;

var Ct = (e, t, r, n) => {
    let o, i, u, a, s;
    switch (e = new mt(e, n), t = new bt(t, n), r) {
      case ">":
        o = _t, i = At, u = Ot, a = ">", s = ">=";
        break;
    ...
    for (let r = 0; r < t.set.length; ++r) {
        ...
        let l = null, f = null;
        if (c.forEach((e => {
            e.semver === Et && (e = new gt(">=0.0.0")), l = l || e, f = f || e, o(e.semver, l.semver, n) ? l = e : u(e.semver, f.semver, n) && (f = e);
...
const xt = Qe(), Rt = et(), {ANY: Lt} = Rt, kt = rt, Bt = ae, $t = [ new Rt(">=0.0.0-0") ], Ht = [ new Rt(">=0.0.0") ], Ut = (e, t, r) => {
    if (e === t) {
        return !0;
    }
...
var mr, gr, Er = t, br = dr, Dr = vr, _r = hr, Or = s;
...
"function" == typeof Symbol && "function" == typeof Symbol.for ? (mr = Symbol.for("graceful-fs.queue"), 
gr = Symbol.for("graceful-fs.previous")) : (mr = "___graceful-fs.queue", gr = "___graceful-fs.previous");
...
if (Or.debuglog ? Sr = Or.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (Sr = function() {
    ...
    Ar(Er, Cr), Er.close = function(e) {
        ...
        Sr(Er[mr]), c.equal(Er[mr].length, 0);
    }));
}
...
function jr(e) {
    Sr("ENQUEUE", e[0].name, e[1]), Er[mr].push(e), Ir();
}

function Mr() {
    for (var e = Date.now(), t = 0; t < Er[mr].length; ++t) {
        Er[mr][t].length > 2 && (Er[mr][t][3] = e, Er[mr][t][4] = e);
    }
    Ir();
}

function Ir() {
    if (clearTimeout(wr), wr = void 0, 0 !== Er[mr].length) {
        var e = Er[mr].shift(), t = e[0], r = e[1], n = e[2], o = e[3], i = e[4];
        if (void 0 === o) {
            ...
            a >= Math.min(1.2 * s, 100) ? (Sr("RETRY", t.name, r), t.apply(null, r.concat([ o ]))) : Er[mr].push(e);
        }
...
Tr.checkPath = function(e) {
    if ("win32" === process.platform) {
        if (/[<>:"|?*]/.test(e.replace(xr.parse(e).root, ""))) {
...
const Rr = ir, {checkPath: Lr} = Tr, kr = e => "number" == typeof e ? e : {
    mode: 511,
    ...e
}.mode;
...
const pn = Fr, vn = r, hn = Gr.mkdirsSync, yn = Kr.utimesMillisSync, mn = tn;
    ...
    if (o.isSymbolicLink()) {
        return function(e, t, r, n) {
            ...
            if (e) {
                ...
                if (n.dereference && (e = vn.resolve(process.cwd(), e)), mn.isSrcSubdir(o, e)) {
                    throw new Error(`Cannot copy '${o}' to a subdirectory of itself, '${e}'.`);
                }
                if (mn.isSrcSubdir(e, o)) {
...
function Dn(e, t, r) {
    pn.readdirSync(e).forEach((n => function(e, t, r, n) {
        ...
        const {destStat: u} = mn.checkPathsSync(o, i, "copy", n);
        return gn(u, o, i, n);
    }(n, e, t, r)));
}
...
var _n = function(e, t, r) {
    ...
    const {srcStat: n, destStat: o} = mn.checkPathsSync(e, t, "copy", r);
    if (mn.checkParentPathsSync(e, n, t, "copy"), r.filter && !r.filter(e, t)) {
        return;
    }
    const i = vn.dirname(t);
    return pn.existsSync(i) || hn(i), gn(o, e, t, r);
};
...
const Tn = ur.fromPromise, xn = r, Rn = ir, Ln = Gr;

var kn = {
    createFile: Tn((async function(e) {
        let t;
        try {
            t = await Rn.stat(e);
        } catch {}
...
const bo = ur, {stringify: Do, stripBom: _o} = go;
...
const {stringify: No} = go, {outputFile: To} = Io;

var xo = async function(e, t, r = {}) {
    const n = No(t, r);
    await To(e, n, r);
};

const {stringify: Ro} = go, {outputFileSync: Lo} = Io;
...
$o.outputJson = Bo(xo), $o.outputJsonSync = ko, $o.outputJSON = $o.outputJson, $o.outputJSONSync = $o.outputJsonSync, 
...
var mi, gi, Ei, bi, Di, _i = {
    exports: {}
};

function Oi() {
    return gi ? mi : (gi = 1, mi = (e, t = process.argv) => {
...
const eu = Ti, tu = [ "white", "grey", "black", "blue", "cyan", "green", "magenta", "red", "yellow" ];
...
const Su = Ai("log4js:clustering"), Cu = Au, wu = Ti;
...
const Nu = () => Mu && "0" === process.env[Iu], Tu = () => Fu || Pu && Pu.isMaster || Nu(), xu = e => {
    ju.forEach((t => t(e)));
}, Ru = (e, t) => {
...
var Lu = {
    onlyOnMaster: (e, t) => Tu() ? e() : t,
    isMaster: Tu,
    send: e => {
        Tu() ? xu(e) : (Mu || (e.cluster = {
...
var ga = function(e, t, r, n) {
    ...
    const n = ma.openSync(e, "r+");
    return ma.futimesSync(n, t, r), ma.closeSync(n);
};
...
const Ia = Fr, Na = r, Ta = ya.mkdirsSync, xa = Ea, Ra = Ma;
...
function ka(e, t, r, n) {
    ...
    n.preserveTimestamps ? xa(r, e.atime, e.mtime) : void 0) : function(e, t, r, n) {
...
const Wa = Fr, za = r, Ja = ya.mkdirs, Ka = Va.pathExists, qa = ga, Xa = Ma;
...
function hs(e, t, r) {
    ...
    n.isDirectory() ? gs(e, t, r) : t.unlinkSync(e);
}
...
function ms(e, t) {
    ...
    try {
        r && r.isDirectory() ? gs(e, t, null) : t.unlinkSync(e);
    } catch (r) {
        if ("ENOENT" === r.code) {
            return;
        }
        if ("EPERM" === r.code) {
            return ls ? hs(e, t, r) : gs(e, t, r);
        }
        if ("EISDIR" !== r.code) {
            throw r;
        }
...
function gs(e, t, r) {
    ...
    try {
        ...
        if ("ENOTEMPTY" === n.code || "EEXIST" === n.code || "EPERM" === n.code) {
            !function(e, t) {
                if (cs(e), cs(t), t.readdirSync(e).forEach((r => ms(ss.join(e, r), t))), !ls) {
...
const js = ea.fromCallback, Ms = r, Is = Fr, Ns = ya, Ts = Va.pathExists;
...
var xs = {
    createFile: js((function(e, t) {
        ...
        Is.stat(e, ((n, o) => {
            ...
            Ts(i, ((e, n) => e ? t(e) : n ? r() : void Ns.mkdirs(i, (e => {
                if (e) {
                    return t(e);
                }
                r();
...
var ic, uc = {
    createFile: xs.createFile,
    createFileSync: xs.createFileSync,
    ensureFile: xs.createFile,
    ensureFileSync: xs.createFileSync,
...
const vc = r, hc = ya, yc = Va.pathExists, mc = pc;

var gc = function(e, t, r, n) {
    "function" == typeof r && (n = r, r = {});
    const o = vc.dirname(e);
    yc(o, ((i, u) => i ? n(i) : u ? mc.writeJson(e, t, r, n) : void hc.mkdirs(o, (o => {
        if (o) {
            return n(o);
        }
        mc.writeJson(e, t, r, n);
    }))));
};
...
Sc.outputJson = Ac(gc), Sc.outputJsonSync = Oc, Sc.outputJSON = Sc.outputJson, Sc.outputJSONSync = Sc.outputJsonSync, 
...
!function(e) {
    e.exports = Object.assign({}, Qu, Ha, us, Ps, uc, Cc, ya, xc, Wc, Yc, Va, Ds);
    const r = t;
...
const xl = Ai("log4js:fileSync"), Rl = r, Ll = t, kl = i, Bl = kl.EOL;
...
class Hl {
    constructor(e, t, r, n) {
        if (xl("In RollingFileStream"), t < 0) {
    ...
    shouldRoll() {
        return xl("should roll with current size %d, and max size %d", this.currentSize, this.size), 
    ...
    roll(e) {
        ...
        function u(r) {
            const n = o(r);
            if (xl(`Index of ${r} is ${n}`), 0 === t.backups) {
                Ll.truncateSync(e, 0);
            } else if (n < t.backups) {
                try {
                    Ll.unlinkSync(`${e}.${n + 1}`);
                } catch (e) {}
                xl(`Renaming ${r} -> ${e}.${n + 1}`), Ll.renameSync(Rl.join(Rl.dirname(e), r), `${e}.${n + 1}`);
            }
        }
        xl("Rolling, rolling, rolling"), xl("Renaming the old files"), Ll.readdirSync(Rl.dirname(e)).filter(n).sort(i).reverse().forEach(u);
    }
    write(e, t) {
        const r = this;
        xl("in write"), this.shouldRoll() && (this.currentSize = 0, this.roll(this.filename)), 
        xl("writing the chunk to the file"), r.currentSize += e.length, Ll.appendFileSync(r.filename, e);
    }
}

Tl.configure = function(e, t) {
    let r = t.basicLayout;
    ...
    return function(e, t, r, n, o, i) {
        ...
        xl("Creating fileSync appender (", e, ", ", r, ", ", n = n || 0 === n ? n : 5, ", ", o, ", ", i, ")");
...
const Wl = r, zl = Ai("log4js:appenders"), Jl = Ti, Kl = Lu, ql = nu, Xl = Qi, Yl = ku, Zl = new Map;
...
Zl.set("fileSync", Tl), Zl.set("tcp", Ul);
...
!function(e) {
    const t = Ai("log4js:categories"), r = Ti, n = nu, o = af, i = new Map;
    function u(e, t, r) {
        if (!1 === t.inherit) {
            return;
        }
...
const lf = Ai("log4js:logger"), ff = Au, df = nu, pf = Lu, vf = cf, hf = Ti, yf = /at (?:(.+)\s+\()?(?:(.+?):(\d+)(?::(\d+))?|([^)]+))\)?/;
...
let gf = class {
    constructor(e) {
        ...
        this.category = e, this.context = {}, this.callStackSkipIndex = 0, this.parseCallStack = mf, 
...
function Ef(e) {
    ...
    gf.prototype[`is${n}Enabled`] = function() {
        return this.isLevelEnabled(t);
    }, gf.prototype[r] = function(...e) {
        this.log(t, ...e);
    };
}
...
const Pf = Ai("log4js:main"), jf = t, Mf = Si({
    proto: !0
}), If = Ti, Nf = af, Tf = cf, xf = bf, Rf = Lu, Lf = Ff;
...
function Bf(e) {
    ...
    Tf.appendersForCategory(e.categoryName).forEach((t => {
        t(e);
    }));
}
...
!function(e) {
    ...
    let f, d, p, v, h, m, g = "start", E = [], b = 0, D = 1, _ = 0, O = !1, A = "default", S = "'", C = 1;
    function w(e, t = !1) {
        d = String(e), g = "start", E = [], b = 0, D = 1, _ = 0, v = void 0, O = t;
        do {
            f = F(), x[g]();
        } while ("eof" !== f.type);
        return v;
    ...
    const M = {
        default() {
            ...
            if (!s.JudgeUtil.isIgnoreChar(m) && !s.JudgeUtil.isSpaceSeparator(m)) {
                return M[g]();
            }
            j();
        },
        ...
        beforePropertyName() {
            switch (m) {
              ...
              case '"':
              case "'":
                return S = m, j(), void (A = "string");
            }
            if (s.JudgeUtil.isIdStartChar(m)) {
                return h += j(), void (A = "identifierName");
            }
            throw B(c.Char, j());
        },
        ...
        value() {
            switch (m) {
              ...
              case '"':
              case "'":
                return S = m, j(), h = "", void (A = "string");
            }
            if (void 0 === m || !s.JudgeUtil.isDigitWithoutZero(m)) {
                throw B(c.Char, j());
            }
            A = "numerical";
        },
        ...
        identifierName() {
            ...
            if (!s.JudgeUtil.isIdContinueChar(m)) {
    ...
    const x = {
        ...
        beforePropertyName() {
            switch (f.type) {
              case "identifier":
              case "string":
                return p = f.value, void (g = "afterPropertyName");
        ...
        afterPropertyValue() {
            ...
            switch (f.value) {
              case ",":
                return void (g = "beforePropertyName");
        ...
        afterArrayValue() {
            ...
            switch (f.value) {
              case ",":
                return void (g = "beforeArrayValue");
    ...
    function R() {
        ...
        !function(e) {
            if (e && "object" == typeof e) {
                E.push(e), g = Array.isArray(e) ? "beforeArrayValue" : "beforePropertyName";
            } else {
                const e = E[E.length - 1];
                g = e ? Array.isArray(e) ? "afterArrayValue" : "afterPropertyValue" : "end";
            }
        }(e);
    }
    function L() {
...
hd.baseAssignValue = md;

var gd = Object.prototype.hasOwnProperty;

hd.assignValue = function(e, t, r) {
    var n = e[t];
    gd.call(e, t) && (0, yd.isEqual)(n, r) && (void 0 !== r || t in e) || md(e, t, r);
};
...
var Nd = ed, Td = Id(Cd), xd = Object.prototype.hasOwnProperty;
...
Sd.default = function(e, t) {
    ...
    for (var u in e) {
        !t && !xd.call(e, u) || r && ("length" === u || (0, Nd.isIndex)(u, n)) || o.push(u);
    }
    return o;
};
...
var yp = {}, mp = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
yp.numMulti = bp, yp.default = function(e, t) {
    ...
    var r = (0, gp.default)(t) ? 0 : Math.floor((0, Ep.default)(t)), n = Number(e);
    if (0 === r) {
        return Math.floor(n);
    }
...
var Tp = Object.prototype.propertyIsEnumerable, xp = Object.getOwnPropertySymbols;

function Rp(e) {
    var t = e;
    return null == t ? [] : (t = Object(t), xp(t).filter((function(e) {
        return Tp.call(t, e);
    })));
}
...
var mv = {}, gv = y && y.__read || function(e, t) {
    var r = "function" == typeof Symbol && e[Symbol.iterator];
    if (!r) {
        return e;
    }
...
Object.defineProperty(mv, "__esModule", {
    value: !0
}), mv.getAllKeysIn = void 0;

var Dv = bv(_d), _v = Mp;

mv.getAllKeysIn = function(e) {
    var t = [];
    for (var r in e) {
        Object.hasOwnProperty.call(e, r) && t.push(r);
    }
    return Array.isArray(e) || t.push.apply(t, Ev([], gv((0, _v.getSymbolsIn)(e)), !1)), 
    t;
}, mv.default = function(e) {
    var t = (0, Dv.default)(e);
    return Array.isArray(e) || t.push.apply(t, Ev([], gv((0, _v.getSymbols)(e)), !1)), 
    t;
};
...
var Fv = ed, Pv = wv(td), jv = wv(Pp), Mv = Cv(jp), Iv = vd, Nv = wv(Bp), Tv = Jp, xv = wv(Cd), Rv = Cv(mv), Lv = wv(_d), kv = Ov, Bv = hd;
...
var yh = Object.prototype.hasOwnProperty, mh = [ uh, ah, sh, ch, lh, fh, dh, ph, vh ], gh = [ qv, Xv ], Eh = [ Zv, rh ];
...
Fp.default = function e(t, r, n, o, i, u) {
    ...
    var m = f ? void 0 : h(t);
    return (0, kv.arrayEach)(m || t, (function(o, i) {
        var u = i, s = o;
        m && (s = t[u = s]), (0, Bv.assignValue)(a, u, e(s, r, n, u, t, v));
    })), a;
};
...
var Th = "object" == typeof y && null !== y && y.Object === Object && y;

Nh.default = Th;

var xh = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var Rh = xh(Nh), Lh = "object" == typeof globalThis && null !== globalThis && globalThis.Object === Object && globalThis, kh = "object" == typeof self && null !== self && self.Object === Object && self, Bh = Lh || Rh.default || kh || function() {
    return this;
}();
...
var yy = {}, my = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var gy = my(Xp), Ey = sy, by = Symbol ? Symbol.prototype : void 0, Dy = by ? by.valueOf : void 0;
...
var Fy = wy(mv), Py = Object.prototype.hasOwnProperty;
...
Cy.equalObjects = function(e, t, r, n, o, i) {
    ...
    var v = function(e, t, r, n, o, i, u, a, s, c, l, f) {
        for (var d = t, p = n, v = f, h = e; ++d < r; ) {
            var y = i[p = o[d]], m = u[p], g = void 0;
            if (a && (g = e ? a(m, y, p, u, i, s) : a(y, m, p, i, u, s)), !(void 0 === g ? y === m || c(y, m, l, a, s) : g)) {
                v = !1;
                break;
            }
            h || (h = "constructor" === p);
...
var Ny = Iy(td), Ty = Jp, xy = sy, Ry = yy, Ly = Cy, ky = Iy(wd), By = Iy(jy), $y = Iy(Cd);
...
ay.baseIsEqual = function e(t, r, n, o, i) {
    return t === r || (null == t || null == r || !(0, ky.default)(t) && !(0, ky.default)(r) ? Number.isNaN(t) && Number.isNaN(r) : function(e, t, r, n, o, i) {
        ...
        Ny.default)(t), f = (c = c === Uy ? Vy : c) === Vy, d = (l = l === Uy ? Vy : l) === Vy, p = c === l, v = function(e, t, r, n, o, i, u, a, s, c) {
            var l = r;
            if (e && !t) {
                return l || (l = new Ty.Stack(void 0)), n || (0, $y.default)(o) ? (0, xy.equalArrays)(o, i, u, a, s, l) : (0, 
        ...
        var h = function(e, t, r, n, o, i, u, a) {
            ...
            if (!(e & Hy)) {
                ...
                if (c || l) {
                    ...
                    return s || (s = new Ty.Stack(void 0)), u(f, d, e, a, s);
                }
            }
            return NaN;
        }(r, f, e, t, d, u, o, n);
...
var em = {}, tm = {}, rm = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var nm = rm(jy), om = rm(up), im = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, um = /^\w*$/;

tm.isKey = function(e, t) {
    if ((0, nm.default)(e)) {
        return !1;
    }
    var r = typeof e;
    return !("number" !== r && "symbol" !== r && "boolean" !== r && null != e && !(0, 
    om.default)(e)) || (um.test(e) || !im.test(e) || null != t && e in Object(t));
};

var am = {}, sm = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
am.toKey = function(e) {
    if ("string" == typeof e || (0, cm.default)(e)) {
        return e;
    }
    var t = "".concat(e);
...
var lm = {}, fm = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
Object.defineProperty(lm, "__esModule", {
    value: !0
}), lm.getDeepProperties = void 0;

var dm = am, pm = fm(jy), vm = fm(up);

lm.getDeepProperties = function(e) {
    return function(t) {
        return function(e, t) {
            var r = function(e, t) {
                if ((0, pm.default)(e)) {
                ...
                if ((0, vm.default)(e) || e in t) {
                    return [ e ];
                }
                return function(e) {
                    var t = [];
                    "." === e[0] && t.push("");
                    return e.replace(hm, (function(e, r, n, o) {
                        return t.push(n ? o.replace(ym, "$1") : r || e), e;
                    })), t;
                }(function(e) {
                    if ((0, vm.default)(e)) {
                        return e;
...
var hm = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, ym = /\\(\\)?/g;

Object.defineProperty(em, "__esModule", {
    value: !0
}), em.getProperties = void 0;

var mm = tm, gm = am, Em = lm;

em.getProperties = function(e) {
    return (0, mm.isKey)(e) ? (t = (0, gm.toKey)(e), function(e) {
        return null == e ? void 0 : e[t];
    }) : (0, Em.getDeepProperties)(e);
    var t;
...
oy.baseIteratee = function(e) {
    return "function" == typeof e ? e : null == e ? _m : "object" == typeof e ? (0, 
    bm.baseMatches)(e) : (0, Dm.getProperties)(e);
...
qh.default = function(e, t) {
    return (Array.isArray(e) ? Sm : Om.dealWithObject)(e, (0, Am.baseIteratee)(t));
};

var Cm = y && y.__values || function(e) {
    var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], n = 0;
    if (r) {
        return r.call(e);
    }
...
var Fm = qp, Pm = wm(qh), jm = cy;

Kh.baseDifference = function(e, t, r, n) {
    var o, i, u = Fm.arrayIncludes, a = !0, s = [], c = t, l = c.length, f = "function" == typeof r;
    if (!(null == e ? void 0 : e.length)) {
        return s;
    }
    r && (c = (0, Pm.default)(c, (function(e) {
        return f ? r(e) : e[r];
    }))), n ? (u = Fm.arrayIncludesWith, a = !1) : c.length >= 200 && (u = Fm.cacheHas, 
    a = !1, c = new jm.SetCache(c));
    var d = !1;
    try {
        for (var p = Cm(e), v = p.next(); !v.done; v = p.next()) {
            var h = v.value, y = h;
...
var Mm = {}, Im = y && y.__values || function(e) {
    var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], n = 0;
    if (r) {
        return r.call(e);
    }
    ...
    return u;
}, Tm = y && y.__spreadArray || function(e, t, r) {
    if (r || 2 === arguments.length) {
        for (var n, o = 0, i = t.length; o < i; o++) {
            !n && o in t || (n || (n = Array.prototype.slice.call(t, 0, o)), n[o] = t[o]);
        }
...
Object.defineProperty(Mm, "__esModule", {
    value: !0
}), Mm.baseFlatten = void 0;

var xm = ed;

Mm.baseFlatten = function e(t, r, n, o, i) {
    var u, a, s = n;
    s || (s = xm.isFlattenable);
    var c = i;
    if (c || (c = []), null == t) {
        return c;
    }
    try {
        for (var l = Im(t), f = l.next(); !f.done; f = l.next()) {
            var d = f.value;
            r > 0 && s(d) ? r > 1 ? e(d, r - 1, s, o, c) : c.push.apply(c, Tm([], Nm(d), !1)) : o || (c[c.length] = d);
        }
    } catch (e) {
        u = {
            error: e
...
var Rm = {}, Lm = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var km = Lm(Od), Bm = Lm(wd);

Rm.default = function(e) {
    return (0, Bm.default)(e) && (0, km.default)(e);
};
...
var Hm = Kh, Um = Mm, Gm = $m(Rm);

Jh.default = function(e) {
    for (var t = [], r = 1; r < arguments.length; r++) {
        t[r - 1] = arguments[r];
    }
    return (0, Gm.default)(e) ? (0, Hm.baseDifference)(e, (0, Um.baseFlatten)(t, 1, Gm.default, !0, void 0), void 0, void 0) : [];
};
...
var Wm = {}, zm = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
Wm.default = function(e, t) {
    return void 0 === t && (t = 1), !(0, Km.isArray)(e) || t >= e.length ? [] : t < 0 ? e : e.slice((0, 
    Jm.default)(t), e.length);
};
...
var Xm = {}, Ym = {}, Zm = y && y.__values || function(e) {
    var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], n = 0;
    if (r) {
        return r.call(e);
    }
    ...
    throw new TypeError(t ? "Object is not iterable." : "Symbol.iterator is not defined.");
}, Qm = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
Ym.default = function(e, t) {
    var r, n, o, i, u = Object(e);
    if (Array.isArray(u)) {
        for (var a = -1, s = e.length; ++a < s; ) {
            t(e[a], a);
        }
    } else if ((0, eg.default)(u)) {
        try {
            for (var c = Zm(u), l = c.next(); !l.done; l = c.next()) {
                t(l.value);
            }
        } catch (e) {
            r = {
        ...
        var f = Object.keys(u);
        try {
            for (var d = Zm(f), p = d.next(); !p.done; p = d.next()) {
                var v = p.value;
                t(u[v], v);
            }
        } catch (e) {
...
var tg = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var ag = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var sg = og, cg = ag(Od), lg = ag(ug);

ng.default = function(e, t) {
    void 0 === t && (t = lg.default);
    var r = Object(e), n = (0, cg.default)(r), o = [], i = (0, sg.wrapIteratee)(t);
    if (n) {
...
dg.default = function(e, t, r) {
    if ((0, pg.checkArrayLenValid)(e)) {
        return -1;
    }
    var n = (0, pg.getValidIndex)(r, 0);
    return function(e, t, r, n) {
        if (void 0 === r && (r = 0), void 0 === n && (n = pg.ArrayDirection.LEFT), n === pg.ArrayDirection.LEFT) {
        ...
        return -1;
    }(e, (0, pg.wrapIteratee)(t), n >= 0 ? n : Math.max(n + e.length, 0));
};

var vg = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var hg = og, yg = vg(Od), mg = vg(dg);

fg.default = function(e, t, r) {
    var n = Object(e), o = -1;
    if ((0, yg.default)(n)) {
        if ((o = (0, mg.default)(e, t, r)) > -1) {
            return n[o];
        }
    } else {
        var i = (0, hg.wrapIteratee)(t), u = Object.keys(n);
        if ((o = (0, mg.default)(u, (function(e) {
            return i(n[e], e, n);
        }), r)) > -1) {
            return n[u[o]];
        }
...
}(Eg), Object.defineProperty(gg, "__esModule", {
    value: !0
});

var bg = Eg, Dg = og;

gg.default = function(e, t, r) {
    if ((0, Dg.checkArrayLenValid)(e)) {
        return -1;
    }
    try {
        var n = (0, bg.getStartIndex)(e, r);
        return function(e, t, r) {
            void 0 === r && (r = 0);
            ...
            return -1;
        }(e, (0, Dg.wrapIteratee)(t), n);
    } catch (e) {
        return -1;
    }
};

var _g = {}, Og = y && y.__values || function(e) {
    var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], n = 0;
    if (r) {
        return r.call(e);
    }
...
_g.default = function(e) {
    ...
    if ((0, Cg.default)(e)) {
        try {
            for (var o = Og(e), i = o.next(); !i.done; i = o.next()) {
                var u = i.value;
                (0, Sg.default)(u) ? wg(n, u) : n.push(u);
            }
        } catch (e) {
            t = {
                error: e
...
Pg.default = function(e) {
    return "[object String]" === (0, jg.tagName)(e);
};

var Mg = y && y.__values || function(e) {
    var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], n = 0;
    if (r) {
        return r.call(e);
    }
    ...
    throw new TypeError(t ? "Object is not iterable." : "Symbol.iterator is not defined.");
}, Ig = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var Ng = Ig(Od), Tg = Ig(jy), xg = Ig(Pg);

function Rg(e, t) {
    for (var r = 0; r < e.length; r++) {
        var n = e["".concat(r)];
        (0, Ng.default)(n) && !(0, xg.default)(n) ? Rg(n, t) : t.push(n);
    }
    return t;
}
...
Fg.default = function(e) {
    ...
    if ((0, Tg.default)(e)) {
        try {
            for (var o = Mg(e), i = o.next(); !i.done; i = o.next()) {
                var u = i.value;
                (0, Ng.default)(u) ? Rg(u, n) : n.push(u);
            }
        } catch (e) {
            t = {
                error: e
    ...
    for (var a = 0; a < e.length; a++) {
        (0, Ng.default)(e["".concat(a)]) ? Rg(e["".concat(a)], n) : n.push(e["".concat(a)]);
    }
    return n;
};
...
var kg = {}, Bg = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
kg.default = function(e, t) {
    return "[object Array]" === Object.prototype.toString.call(e) ? function(e, t) {
        ...
        return "string" == typeof t ? e.forEach((function(e) {
            ...
            if ((Array.isArray(e) || (0, $g.default)(e)) && "number" == typeof t) {
                Hg(r, e[t], e);
            } else {
                var n = t && t(e);
                Hg(r, "".concat(n = n || e), e);
...
var Ug = {}, Gg = {}, Vg = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var Wg = Vg(jy), zg = Vg(up), Jg = ed;

function Kg(e) {
    return (0, zg.default)(e) ? e : "".concat(e);
}

var qg = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Xg = /\\(\\)?/g;

function Yg(e, t) {
    return (0, Wg.default)(e) ? e : (0, zg.default)(e) || e in t ? [ e ] : function(e) {
        var t = [];
        return "." === e[0] && t.push(""), e.replace(qg, (function(e, r, n, o) {
            return t.push(n ? o.replace(Xg, "$1") : r || e), e;
        })), t;
    }(Kg(e));
}

function Zg(e, t) {
    if (!(0, Wg.default)(e) && !(0, Jg.isArguments)(e)) {
        return !1;
    }
    var r = Number(t);
...
Gg.default = function(e, t, r) {
    for (var n = Yg(t, e), o = n.length, i = -1, u = e; ++i < o; ) {
        var a = Kg(n[i]);
        if (!r(u, a) && !Zg(u, a)) {
            return !1;
        }
...
var Qg = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var fE = lE(Od), dE = lE(oE), pE = lE(ip), vE = lE(Pg), hE = lE(aE);
...
var mE = {}, gE = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var NE = {}, TE = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var xE = TE(Xp), RE = TE(wd), LE = TE(jy), kE = TE(td), BE = TE(Cd), $E = TE(mv), HE = TE(ip), UE = Jp, GE = qp, VE = cy, WE = function(e) {
    ...
    switch (r) {
      ...
      default:
        a = function(e, t, r) {
            ...
            xE.default)(+e, +t) : [ "[object RegExp]", "[object String]" ].includes(r) ? "".concat(e) === "".concat(t) : [ "[object Error]" ].includes(r) ? e.name === t.name && e.message === t.message : !(![ "[object Symbol]" ].includes(r) || !Symbol.prototype.valueOf) && Symbol.prototype.valueOf.call(e) === Symbol.prototype.valueOf.call(t);
        }(s, c, r);
    }
    return a;
}
...
function QE(e, t, r) {
    ...
    return c === ZE((0, LE.default)(t), t) && "[object Object]" !== c ? function(e) {
        ...
        if (p && !h) {
            ...
            g === E || !("constructor" in e) || !("constructor" in t) || "function" == typeof g && g instanceof g && "function" == typeof E && E instanceof E || (p = !1);
        }
    ...
    if (e && "number" != typeof e && e.length > 0) {
        ...
        try {
            for (var o = vb(e), i = o.next(); !i.done; i = o.next()) {
                var u = i.value;
                (u > n || (0, yb.default)(n) || (0, mb.default)(n)) && (n = u);
            }
        } catch (e) {
            t = {
                error: e
...
bb.default = function(e) {
    ...
    var r = Qf, n = hd, o = Fp, i = t(Eb), u = t(Pp), a = t(bb), s = Jp, c = ed, l = t(Xp), f = t(Rm), d = t(rb), p = t($p), v = t(wE), h = t(Cd), m = t(Bp);
    function g(e, t) {
    ...
    function b(e, t, r, n, s, l, y) {
        var m = g(e, r), b = g(t, r), D = y.get(b);
        if (D) {
            E(e, r, D);
        } else {
            var _ = l ? l(m, b, "".concat(r), e, t, y) : void 0, O = void 0 === _;
            if (O) {
                var A = function(e, t) {
        ...
        if (t !== r) {
            ...
            (0, m.default)(r).forEach((function(i) {
                ...
                if ((0, p.default)(a)) {
                    ...
                    var s = o ? o(g(t, i), a, "".concat(i), t, r, u) : void 0;
...
var jb = {}, Mb = {}, Ib = {}, Nb = y && y.__read || function(e, t) {
    ...
    return u;
}, Tb = y && y.__spreadArray || function(e, t, r) {
    if (r || 2 === arguments.length) {
        for (var n, o = 0, i = t.length; o < i; o++) {
            !n && o in t || (n || (n = Array.prototype.slice.call(t, 0, o)), n[o] = t[o]);
        }
...
Object.defineProperty(Ib, "__esModule", {
    ...
    var n = [];
    t.forEach((function(e) {
        Array.isArray(e) ? n.push.apply(n, Tb([], Nb(e), !1)) : n.push(e);
    }));
...
var xb = {}, Rb = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var Gb = Ub(Ib), Vb = Ub(ib), Wb = Ub(xb), zb = ed, Jb = Ub(up), Kb = Ub(wh), qb = Ub(Pg);
...
var TD = ND(Rd), xD = ND(_d), RD = function(e) {
    return e;
};
...
ID.default = function(e, t, r) {
    ...
    return Array.isArray(e) ? function(e, t, r, n) {
        var o = (0, TD.default)(e) ? 0 : e.length, i = 0, u = n;
        r && o > 0 && (u = e[0], i = 1);
        for (var a = i; a < o; a++) {
            u = t(u, e[a], a, e);
        }
        ...
        var o = (0, xD.default)(e), i = o.length, u = 0, a = n;
        r && i > 0 && (a = e[o[0]], u = 1);
        for (var s = u; s < i; s++) {
            var c = o[s];
            a = t(a, e[c], c, e);
...
var n_ = r_(Pg), o_ = t_(ib), i_ = r_(XD), u_ = r_(ip);
...
var v_ = {}, h_ = y && y.__read || function(e, t) {
    ...
    return e.concat(n || Array.prototype.slice.call(t));
}, m_ = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var g_ = m_(Od), E_ = m_($p), b_ = m_(Pg), D_ = m_(yp), __ = m_(ip);

v_.default = function(e, t, r) {
    if (!Array.isArray(e) && !(0, g_.default)(e)) {
        return [];
    }
    var n = r > e.length ? e.length : r, o = [];
    return !Array.isArray(e) && (0, g_.default)(e) ? (n = e.length, o.push.apply(o, y_([], h_(function(e) {
        var t = [];
...
var T_ = {}, x_ = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var R_ = x_(Rd), L_ = String ? String.prototype.toLowerCase : void 0;
...
var nO = rO(ID), oO = rO(Od), iO = rO(Ym), uO = rO(Q_), aO = rO(fb), sO = rO(rb);
...
var mO = {}, gO = {}, EO = y && y.__read || function(e, t) {
    var r = "function" == typeof Symbol && e[Symbol.iterator];
    if (!r) {
        return e;
    }
...
var NO = {}, TO = y && y.__importDefault || function(e) {
    return e && e.__esModule ? e : {
        default: e
    };
};
...
var xO = TO(Rd), RO = TO(Q_);

NO.default = function(e) {
    for (var t = [], r = 1; r < arguments.length; r++) {
        t[r - 1] = arguments[r];
    }
    return (0, xO.default)(t) ? [].concat(e) : e.filter((function(e) {
...
var ZO = YO(ug), QO = YO(op), eA = YO(Rd);
...
var dA = fA(ug), pA = fA(Q_), vA = fA(Rd), hA = fA(jy), yA = fA(wO), mA = fA(Od), gA = fA(_d), EA = fA(NE);

function bA(e, t) {
    var r = [], n = [];
    if ((0, vA.default)(e) || !(0, mA.default)(e)) {
        return r;
    }
...
var ZA = YA(Rd), QA = YA(xb), eS = YA(_A);
...
var nS = rS(Rd), oS = rS(xb), iS = rS(_A);
...
var sS = aS(Rd), cS = aS(xb), lS = aS(_A);
...
var pS = dS(Rd), vS = dS(xb), hS = dS(_A), yS = dS(J_), mS = dS(T_);
...
var TS = NS(J_), xS = NS(xb);

IS.default = function(e) {
    return (0, TS.default)((0, xS.default)(e).toLowerCase());
};
...
var oC = nC(qS), iC = nC(xb), uC = nC(XS), aC = nC(gb), sC = "Invalid `variable` settings for template function", cC = /\b__p \+= '';/g, lC = /\b(__p \+=) '' \+/g, fC = /(__e\(.*?\)|\b__t\)) \+\n'';/g, dC = /[()=,{}[\]/\s]/, pC = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, vC = /($^)/, hC = /['\n\r\u2028\u2029\\]/g, yC = {
    "\\": "\\",
    "'": "'",
    "\n": "n",
    "\r": "r",
...
tC.default = function(e, t, r) {
    ...
    r && r[o] === e && (o = void 0);
    var i, u = (0, iC.default)(e), a = (0, aC.default)({}, n, o), s = a.imports, c = gC.call(a, "sourceURL") ? "//# sourceURL=".concat("".concat(a.sourceURL).replace(/\s/g, " "), "\n") : "", l = function(e) {
        ...
        return t.replace(c, (function(e, r, n, u, c, l) {
            var f = n || u;
            return s += t.slice(a, l).replace(hC, mC), r && (i = !0, s += "' +\n__e(".concat(r, ") +\n'")), 
...
var TC = {}, xC = y && y.__values || function(e) {
    var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], n = 0;
    if (r) {
        return r.call(e);
    }
...
TC.default = function() {
    ...
    for (var o = [], i = function(e) {
        var t, r, n = 0;
        try {
            for (var o = xC(e), i = o.next(); !i.done; i = o.next()) {
                var u = i.value;
        ...
        var a = [];
        try {
            for (var s = (e = void 0, xC(r)), c = s.next(); !c.done; c = s.next()) {
                var l = c.value;
...
var mw = yw(wO), gw = hw(QC), Ew = XD, bw = yw(_h), Dw = ap;
...
dw.default = function(e, t) {
    ...
    return function(t) {
        ...
        mw.default)(t, o) : t, u = n[n.length - 1] || "";
        if (null == i) {
            return !1;
        }
        ...
        i = i[u];
        var a = typeof r;
        return (0, gw.needDeeperCompare)(i, r) || "function" === a ? (0, gw.default)(i, r) : i === r;
    };
};
...
var Sw = ap, Cw = Aw(ZC), ww = Aw(wO), Fw = Aw(dw), Pw = Aw(_d), jw = Aw(ug);
...
var Tw = {}, xw = y && y.__read || function(e, t) {
    var r = "function" == typeof Symbol && e[Symbol.iterator];
    if (!r) {
        return e;
    }
...
Tw.default = function() {
    ...
    return kw.default.apply(void 0, Rw([], xw(e), !1));
};
...
var fF = lF(Rd), dF = lF(xb), pF = lF(Yw), vF = lF(Pg), hF = lF(eF), yF = lF(Ug), mF = {
    length: 30,
    omission: "..."
};
...
function gF(e) {
    var t = {};
    return function(e, t) {
        (0, yF.default)(e, "omission") ? t.omission = e.omission : t.omission = mF.omission, 
        (0, yF.default)(e, "length") ? t.length = e.length : t.length = mF.length, (0, yF.default)(e, "separator") && (t.separator = e.separator);
    }(e, t), null === t.omission && (t.omission = "null"), void 0 === t.omission && (t.omission = "undefined"), 
    void 0 === t.length && (t.length = mF.length), t.length = (0, hF.default)(t.length), 
    t.length < 0 && (t.length = 0), t;
}

Xw.default = function(e, t) {
    void 0 === e && (e = "");
    var r = (0, fF.default)(t) ? mF : t;
    r = gF(r);
...
var bF = gb, DF = (0, Qf.createAssignFunction)((function(e, t, r, n) {
...
var AF = OF(qw), SF = OF(Bw), CF = OF(TC);
...
!function(e) {
    ...
    const o = t(ii), i = t(r), u = t(n), a = xF, s = rr, c = nr, l = fi;
    class f {
...
!function(e) {
    ...
    const n = t(r), o = Yf, i = t(ii), u = NF, a = TF, s = RF;
    class c {
        constructor() {
...
!function(e) {
    ...
    const n = Gf, o = t(r), i = TF, u = nr, a = rr;
    e.logFilePath = () => {
        let e;
        try {
...
function rP() {
    return ZF || (ZF = 1, function(e) {
        ...
        const t = gP(), r = dP(), n = nP(), o = kF, i = oP(), u = LF;
        var a;
        !function(e) {
...
function nP() {
    return QF || (QF = 1, function(e) {
        ...
        const n = UF, o = (zF || (zF = 1, function(e) {
            ...
            const o = n(t), i = n(ii), u = n(r), a = VF, s = TF, c = di;
            class l {
                constructor() {
...
function gP() {
    return vP || (vP = 1, function(e) {
        ...
        const o = n(s), i = n(Gf), u = qf, a = LF, c = dP(), l = pP, f = mP, d = KF;
        class p {
            constructor(e, t) {
...
function EP() {
    return yP || (yP = 1, function(e) {
        ...
        function(e) {
            ...
            const s = u(t), c = v, l = a(i), f = u(r), d = Vf, p = gP();
            class h {
...
function wP() {
    return bP || (bP = 1, function(e) {
        ...
        const s = o, c = a(t), l = a(ii), f = u(r), d = rr, p = Vf, v = IP(), h = Qt, m = SP;
        ...
        e.hasNpmPackInPaths = function(e, t) {
            ...
            var e, t, r;
            const n = f.resolve(m.HVIGOR_USER_HOME, d.DEFAULT_HVIGOR_CONFIG_JSON_FILE_NAME);
            let o;
...
function FP() {
    return DP || (DP = 1, function(e) {
        ...
        const c = o, l = a(t), f = s(i), d = a(r), p = rr, v = or, h = IP(), m = Qt, g = wP();
        function E() {
            let e = "";
            const t = "[39m";
        ...
        e.PNPM_VERSION = "8.13.1", e.checkNpmConifg = function() {
            ...
            if ((0, g.isFileExists)(e) || (0, g.isFileExists)(t)) {
                return;
            }
            const n = (0, g.getNpmPath)(), o = (0, c.spawnSync)(n, [ "config", "get", "prefix" ], {
                cwd: process.cwd()
            });
        ...
        e.isPnpmInstalled = function() {
            return !!l.existsSync(_) && (0, g.hasNpmPackInPaths)("pnpm", [ D ]);
        }, e.executeInstallPnpm = function() {
            (0, m.logInfo)(`Installing pnpm@${e.PNPM_VERSION}...`);
            const t = (0, g.getNpmPath)();
            (function() {
                ...
                try {
                    ...
                    (0, m.logErrorAndExit)(`Error: EPERM: operation not permitted,create ${t} failed.`);
                }
            })(), (0, g.executeCommand)(t, [ "install", "pnpm" ], {
                cwd: D,
...
function IP() {
    return jP || (jP = 1, function(e) {
        ...
        const c = a(t), l = s(ii), f = s(i), d = a(r), p = s(n), v = Yt, h = rr, g = nr, E = m, b = NF, D = Vf, _ = Qt, O = FP(), A = wP(), S = SP, C = PP, w = MP.version;
        let F, P, j;
        ...
        e.initProjectWorkSpace = function() {
            ...
            P = function() {
                ...
                for (const e in null == F ? void 0 : F.dependencies) {
                    if (!(0, A.hasNpmPackInPaths)(e, [ j ]) || !x(e, F, P)) {
                        return !1;
                    }
                }
                return !0;
                ...
                try {
                    (0, O.checkNpmConifg)(), function() {
                        ...
                        !(0, A.isHvigorDependencyUseNpm)() && (0, v.gte)(M, A.BASE_NODE_VERSION) && function() {
                            ...
                            const e = [ "install" ];
                            (0, E.isCI)() && e.push("--no-frozen-lockfile"), l.default.existsSync(d.resolve(g.HVIGOR_PROJECT_ROOT_DIR, ".npmrc")) && (p.default.env.npm_config_userconfig = function(e) {
                                ...
                                return t;
                            }(d.resolve(g.HVIGOR_PROJECT_ROOT_DIR, ".npmrc")));
                            const t = {
                                cwd: j,
                                stdio: [ "inherit", "inherit", "inherit" ],
                                env: p.default.env
        ...
        function N(e) {
            ...
            try {
                l.default.ensureDirSync(r), (null == F ? void 0 : F.dependencies["@ohos/hvigor"]) || T(d.resolve(r, "hvigor"), d.resolve(t, "hvigor"), n), 
                (null == F ? void 0 : F.dependencies["@ohos/hvigor-ohos-plugin"]) || T(d.resolve(r, "hvigor-ohos-plugin"), d.resolve(t, "hvigor-ohos-plugin"), n);
            } catch (e) {
                (0, _.logErrorAndExit)(e);
            }
        }
        ...
        function R() {
            var e;
            const t = d.resolve(g.HVIGOR_PROJECT_WRAPPER_HOME, h.DEFAULT_HVIGOR_CONFIG_JSON_FILE_NAME);
            let r;
...
var NP = IP(), TP = FP(), xP = wP();

!function() {
    TP.environmentHandler(), Yt.gte(n.version.slice(1), xP.BASE_NODE_VERSION) && !xP.isHvigorDependencyUseNpm() && (TP.isPnpmInstalled() || (TP.checkNpmConifg(), 
    TP.executeInstallPnpm()));
    const e = r.resolve(__dirname, "../../ohpm/bin/", m.isWindows() ? "ohpm.bat" : "ohpm");
